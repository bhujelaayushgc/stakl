...
web
## Stack
Go, SQLite, YAML, React, TypeScript, Vite, Tailwind CSS, Lucide. Frontend embedded in one executable.
## Users
Developers managing many local projects on macOS and Linux for daily personal use.
## Product Purpose
Start, inspect, and stop arbitrary local applications from one control plane without registering each as an OS service.
